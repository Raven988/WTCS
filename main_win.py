...
class Ui_MW(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_11.setIconSize(QtCore.QSize(45, 30))
...
"color: rgb(0, 0, 0);")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/task.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Процедура"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Код 'из'"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Код 'в'"))
