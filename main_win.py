...
class Ui_MW(object):
    def setupUi(self, MainWindow):
        ...
        self.camera_label2 = QtWidgets.QLabel(self.tab)
        self.camera_label2.setMinimumSize(QtCore.QSize(0, 300))
        self.camera_label2.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(75, 75, 75);")
        self.camera_label2.setFrameShape(QtWidgets.QFrame.Panel)
        self.camera_label2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.camera_label2.setLineWidth(2)
        self.camera_label2.setAlignment(QtCore.Qt.AlignCenter)
        self.camera_label2.setObjectName("camera_label2")
        self.verticalLayout_4.addWidget(self.camera_label2)
        self.camera_label = QtWidgets.QLabel(self.tab)
        self.camera_label.setMinimumSize(QtCore.QSize(0, 300))
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.camera_label2.setText(_translate("MainWindow", "Нет сигнала"))
