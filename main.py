...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.calendarWidget.setMaximumSize(QtCore.QSize(16777215, 150))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.setText(_translate("MainWindow", "Скриншот"))
        self.pushButton_11.setText(_translate("MainWindow", "Сделать скриншот"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Камеры"))
        self.pushButton_2.setText(_translate("MainWindow", "Назначить"))
        ...
        self.pushButton_13.setText(_translate("MainWindow", "Редактировать"))
        ...
        self.pushButton_14.setText(_translate("MainWindow", "Редактировать"))
        self.pushButton_8.setText(_translate("MainWindow", "Сделать заявку"))
        ...
        self.pushButton_15.setText(_translate("MainWindow", "Редактировать"))
